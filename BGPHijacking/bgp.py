...
class SimpleTopo(Topo):
    """Topology based on Figure 2 from the BGP Hijacking paper."""
    ...
    def __init__(self):
        ...
        # link the ASs per Figure 2 topology
        self.addLink('R1', 'R2')  # R1-eth3 <-> R2-eth3, subnet 9.0.0.0/24
        self.addLink('R1', 'R3')  # R1-eth4 <-> R3-eth3, subnet 9.0.1.0/24
        self.addLink('R2', 'R3')  # R2-eth4 <-> R3-eth4, subnet 9.0.2.0/24
        self.addLink('R2', 'R5')  # R2-eth5 <-> R5-eth3, subnet 9.0.4.0/24
        self.addLink('R3', 'R4')  # R3-eth5 <-> R4-eth3, subnet 9.0.3.0/24
        self.addLink('R2', 'R4')  # R2-eth6 <-> R4-eth4, subnet 9.0.7.0/24
        self.addLink('R3', 'R5')  # R3-eth6 <-> R5-eth4, subnet 9.0.8.0/24
        self.addLink('R4', 'R5')  # R4-eth5 <-> R5-eth5, subnet 9.0.5.0/24
        self.addLink('R5', 'R6')  # R5-eth6 <-> R6-eth3, subnet 9.0.6.0/24
